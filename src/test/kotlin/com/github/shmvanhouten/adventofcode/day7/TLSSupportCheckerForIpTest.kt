...
class TLSSupportCheckerForIpTest {

    @Test
    fun `it should find 'abba(mnop)qrst' does support TLS`() {
        val checker = TLSSupportCheckerForIp()
        assertThat(checker.doesIpSupportTLS("abba[mnop]qrst"), equalTo(true))
    }

    @Test
    fun `it should find 'abcd(bddb)xyyx' does not support TLS`() {
        val checker = TLSSupportCheckerForIp()
        assertThat(checker.doesIpSupportTLS("abcd[bddb]xyyx"), equalTo(false))
    }

    @Test
    fun `it should find 'aaaa(qwer)tyui' does support TLS`() {
        val checker = TLSSupportCheckerForIp()
        assertThat(checker.doesIpSupportTLS("aaaa[qwer]tyui"), equalTo(false))
    }

    @Test
    fun `it should find 'ioxxoj(asdfgh)zxcvbn' does support TLS`() {
        val checker = TLSSupportCheckerForIp()
        assertThat(checker.doesIpSupportTLS("ioxxoj[asdfgh]zxcvbn"), equalTo(true))
    }

    @Test
    fun `it should find the list of Ips does support TLS`() {
        val checker = TLSSupportCheckerForIp()
        val ips = """abba[mnop]qrst
abba[mnop]qrst
abcd[bddb]xyyxabcd[bddb]xyyx[qwer]
aaaa[qwer]tyui
aaaa[qwer]tyui
